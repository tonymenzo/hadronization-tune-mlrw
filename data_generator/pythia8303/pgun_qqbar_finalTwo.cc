...
int main() {
  ...
  //int MAX_REJECT = 100;
  //
  string hadron_PATH = "pgun_qqbar_finalTwo_hadrons_a_0.72_b_0.88_sigma_0.335_N_5e5.txt";
  string accept_reject_PATH = "pgun_qqbar_finalTwo_accept_reject_z_a_0.72_b_0.88_sigma_0.335_N_5e5.txt";
  string mT2_PATH = "pgun_qqbar_finalTwo_mT2_a_0.72_b_0.88_sigma_0.335_N_5e5.txt";
  string fPrel_PATH = "pgun_qqbar_finalTwo_fPrel_a_0.72_b_0.88_sigma_0.335_N_5e5.txt";
  ...
  do {
    ...
    if (nLines == nHadrons - 2) {
      ...
      ofstream ardatafile(accept_reject_PATH, ios::out | ios::in | ios::app);
      ...
      while (lineCounter < nLines - (nHadrons - 2)) {
        getline(rfile, line);
        ardatafile << line << endl;
        lineCounter++;
      }
    ...
    ofstream cfragfile("fragmentation_chain_i.txt", ios::out | ios::trunc);
    cfragfile.close();
