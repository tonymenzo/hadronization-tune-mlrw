...
int main() {
  ...
  // Set frgamentation parameters.
  //pythia.readString("StringZ:aLund = ")
  //pythia.readString("StringZ:bLund = ")
  //pythia.readString("StringPT:sigma = ")
  ...
  for (int iEvent = 0; iEvent < nevent; ++iEvent) {
    ...
    // Print out string and hadron data.
    pythia.strings.endA.list();
    pythia.strings.endB.list();
    pythia.strings.endC.list();
    pythia.strings.hads.list();
